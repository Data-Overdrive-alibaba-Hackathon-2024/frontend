    ...
    >
      <div className={`${customFont.className} w-[70vh]`}>
        <div className="flex justify-between mb-8 text-gray-400">
          <Link href="/login" className="text-xl text-[#77668E] hover:text-white transition duration-300">Masuk Akun</Link>
          <div className="text-xl text-white">Buat Akun</div>
        </div>
